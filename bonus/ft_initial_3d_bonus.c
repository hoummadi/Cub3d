...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_initial_3d_bonus.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hhoummad <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/19 19:43:35 by hhoummad          #+#    #+#             */
/*   Updated: 2021/01/20 19:28:01 by hhoummad         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	fix_xpm(char *dir, int i)
{
	...
	else if (ft_strnstr(dir, "T ", 2))
		g_tex.t = fillxpm(g_tex2.t, st_x, st_y, g_tex.w[i]);
}
...
static void	dataxpm(char *filename, char *dir, int i)
{
	...
	if (ft_strnstr(dir, "NO ", 3))
		...
		g_tex2.t = (int *)mlx_get_data_addr(xpm_ptr, &nl, &nl, &nl);
	fix_xpm(dir, i);
}
